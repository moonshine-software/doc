...
<x-moonshine::alert type="default" icon="heroicons.book-open">
    Все доступные <x-link link="{{ to_page('icons') }}">иконки</x-link>.
</x-moonshine::alert>
...
<x-moonshine::alert type="default" icon="heroicons.information-circle">
    ...
    <x-link link="{{ to_page('appearance-assets') }}">классы цветов</x-link> TailwindCSS.
</x-moonshine::alert>
...
<x-moonshine::alert type="default" icon="heroicons.information-circle">
    ...
    Используйте <x-link link="{{ to_page('appearance-assets') }}">собственные стили</x-link>.
</x-moonshine::alert>
