<x-page
    title="Системный компонент Header"
    :sectionMenu="[
        'Разделы' => [
            ['url' => '#make', 'label' => 'Make'],
        ]
...
<x-p>
    Системный компонент <em>Header</em> служит для создания блока шапки в <strong>MoonShine</strong>.
</x-p>

<x-p>
    Создать <em>Header</em> можно воспользовавшись статическим методом <code>make()</code>
    класса <code>Header</code>.
</x-p>
