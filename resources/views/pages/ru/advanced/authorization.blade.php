...
<x-p>
    ...
    Если возникают трудности, то ознакомьтесь с <x-link link="https://laravel.com/docs/10.x/authorization" target="_blank">официальной документацией Laravel</x-link>.
</x-p>
