...
<x-p>
    Для активных участников проекта создан отдельный закрытый чат в telegram, если Вы готовы принять участие в разработке, то напишите мне @leeto_telegram и я отправлю приглашение.
</x-p>
