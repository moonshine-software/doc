...
<x-p>
    В результате будет создан Resource класс, который будет основой нового раздела в панеле.
...
<x-p>
    Можно изменить привязку к моделе и заголовок раздела вместе с выполнением команды
    <x-code language="shell">
...
<x-alert>
    После разделы появятся в меню и будут доступны в панеле
</x-alert>
