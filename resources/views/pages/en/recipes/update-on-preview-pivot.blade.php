<x-recipe id="update-on-preview-pivot" title="{{ $title ?? 'Recipe' }}">

<x-p>
    Implementation via <em>asyncMethod</em> of the method for changing the pivot field on the index page:
</x-p>
