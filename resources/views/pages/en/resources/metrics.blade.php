...
<x-p>
    Same as the <x-link link="{{ route('moonshine.page', 'advanced-dashboard') }}">control panel</x-link> you can
    display <x-link link="{{ route('moonshine.page', 'metrics-index') }}">metrics</x-link> in every resource
</x-p>
