<x-page title="MoonShine">
    ...
    <x-sub-title>Hello Laravel user!</x-sub-title>
     ...
     <x-p>
         Welcome to the open-source project dedicated to the "MoonShine" admin panel.
     </x-p>
     <x-p>
         I've been working on it for several years and have used it on dozens of small projects constantly tweaking it.
     </x-p>
     <x-p>
         What does moonshine mean? It's not exactly "moonlight" - my idea is the "moonshine" concept.
         The term means the independent production of a drink in illegal conditions under the cover of the night :)
