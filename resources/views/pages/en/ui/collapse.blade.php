<x-page title="Collapse" :sectionMenu="[
    'Sections' => [
        ...
        ['url' => '#persist', 'label' => 'Saving state'],
    ]
]">
...
<x-p>
    If the <code>show</code> parameter is <code>TRUE</code>,
...
<x-sub-title id="persist">Saving state</x-sub-title>

<x-p>
    If the <code>persist</code> parameter is set to <code>TRUE</code>, then the state of the block will be preserved.
</x-p>
