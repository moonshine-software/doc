<x-page title="Spinner" :sectionMenu="[
    'Sections' => [
        ...
        ['url' => '#position', 'label' => 'Positioning'],
    ]
]">
...
<x-sub-title id="position">Positioning</x-sub-title>

<x-p>
    The <code>absolute="true"</code> parameter specifies the absolute positioning of the loading indicator.
</x-p>
