...
<x-sub-title id="text">Text divider</x-sub-title>

<x-p>
    You can use text as a separator, for this you need to specify the text in the <code>label</code> parameter
</x-p>
