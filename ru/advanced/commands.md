...
Команда для вывода списка всех зарегистрированных страниц MoonShine (исключая страницы ресурсов):
...
Команда для вывода списка всех зарегистрированных ресурсов MoonShine:
...
> [!NOTE]
> Эти команды помогут быстро просмотреть зарегистрированные страницы и ресурсы в вашем приложении MoonShine.
