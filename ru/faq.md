...
Рассмотрим использование полей отношений на примере `BelongsTo`. Например, у вас есть модели `Post` и `Author`,
...
Достаточно расширить базовый класс `Field` или класс любого из имеющихся полей и добавить\переопределить нужный вам
функционал.
