...
- `table_row_updated:{componentName}`(`JsEvent::TABLE_ROW_UPDATED`) - обновление строки таблицы,
- `table_row_added:{componentName}`(`JsEvent::TABLE_ROW_ADDED`) - добавление новой клонированной строки,
- `table_empty_row_added:{componentName}`(`JsEvent::TABLE_EMPTY_ROW_ADDED`) - добавление новой строки,
